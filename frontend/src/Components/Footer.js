    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        ...
                        <p>Uttar Pradesh</p>
                        <p>India</p>
                        <p><b>Email:</b>sgupta782003@gmail.com</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169;2023 copyright all right reserved<br /><span>Designed with ❤️ by Sarthak Gupta</span></p>
            </div>
        </div>
    )
}
